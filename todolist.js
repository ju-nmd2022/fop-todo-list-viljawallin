...
function createTaskElement(task) {
  ...
  doneButton.onclick = () => {
    ...
    // Citation: I used ChatGpt after listening to Garrits lecture about ChatGpt in order to debug my code because at first I could not get my line-through to be saved in localStorage. Accessed April 7, 2023 //
  ...
  deleteButton.onclick = () => {
    // Citation: I took this information from hamstergram-workshop-login by Garrit "post.likes.splice(userIndex, 1);" in order to remove one specific task from the task array. Accessed April 4, 2023 //
...
function displayTasks() {
  ...
  // Citation: I took information from hamstergram-workshop-login by Garrit - from the function displayPosts - order to make my function displayTasks. The same code but changed it to my variebles and the way I wanted my function to work. Accessed April 4, 2023. //
...
addButton.addEventListener("click", () => {
  // Citation: W3Schools How to Create a To-Do List https://www.w3schools.com/howto/howto_js_todolist.asp I accessed it ain April 4, 2023. I used it when it came to get inspiration on how making a new list when clicking the add button in javascript. //
